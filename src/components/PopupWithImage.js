...
function PopupWithImage(props) {
    return (
        <section className= {props.card && !props.onClose ? ("popup popup_picture popup_opened") : ("popup popup_picture")}>
            <div className="popup__container popup__container_type_image">
                ...
                <img className="popup__image" alt="" src={props.card && !props.onClose ? (props.card.link) : ("")}/>
